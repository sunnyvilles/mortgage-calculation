...
var services_module_1 = __webpack_require__(93);
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.onLogin = function () {
        ...
        this.loginService.authenticate(this.user.username, this.user.password)
            ...
            if (result === true) {
                _this.router.navigate(['/mortgages']);
            }
            else {
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [router_1.Router, services_module_1.LoginService])
], LoginComponent);
...
var core_1 = __webpack_require__(13);
var services_module_1 = __webpack_require__(93);
var MortgageComponent = (function () {
    function MortgageComponent(mortgageService) {
        this.mortgageService = mortgageService;
        this.values = {};
        this.resultValue = '0';
    }
    MortgageComponent.prototype.calcMortgage = function () {
        var _this = this;
        this.mortgageService.calcMortgage(this.values.amount, this.values.month, this.values.interest)
            .subscribe(function (result) {
            _this.resultValue = _this.getTwoFixedDecimal(result['data']);
        });
    };
    MortgageComponent.prototype.getTwoFixedDecimal = function (val) {
        return Number(val).toFixed(2);
    };
    return MortgageComponent;
}());
MortgageComponent = __decorate([
    core_1.Component({
        template: __webpack_require__(368)
    }),
    __metadata("design:paramtypes", [services_module_1.MortgageService])
], MortgageComponent);
exports.MortgageComponent = MortgageComponent;
...
var app_routing_1 = __webpack_require__(208);
var login_component_1 = __webpack_require__(128);
var services_module_1 = __webpack_require__(93);
var mortgage_component_1 = __webpack_require__(129);
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            ...
            mortgage_component_1.MortgageComponent
        ],
        providers: [
            services_module_1.LoginService,
            services_module_1.MortgageService,
            app_routing_1.CheckAuth
        ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_forkJoin__ = __webpack_require__(167);
...
var CheckAuth = (function () {
    ...
    CheckAuth.prototype.canActivate = function () {
...
var appRoutes = [
    ...
    { path: "mortgages", component: mortgage_component_1.MortgageComponent, canActivate: [CheckAuth] },
    // Default
...
var LoginService = (function () {
    ...
    */
    LoginService.prototype.authenticate = function (username, password) {
        ...
        var getUrl = '/auth/login?' + params.toString();
...
var http_1 = __webpack_require__(72);
__webpack_require__(117);
var MortgageService = (function () {
    function MortgageService(http) {
        this.http = http;
    }
    MortgageService.prototype.calcMortgage = function (amount, month, interest) {
        var params = new URLSearchParams();
        params.append("amount", amount);
        params.append("month", month);
        params.append("interest", interest);
        var getUrl = 'api/mortgage/calculate?' + params.toString();
...
module.exports = "<div class=\"col-md-6 col-md-offset-3\">\n\n    <form (ngSubmit)=\"onLogin()\" novalidate>\n\n     <div class=\"form-group\">\n       <label for=\"username\">Username</label>\n       <input type=\"text\" class=\"form-control\" id=\"username\" placeholder=\"jones\" [(ngModel)]=\"user.username\" name=\"username\" required>\n     </div>\n\n     <div class=\"form-group\">\n       <label for=\"password\">Password</label>\n       <input type=\"password\" class=\"form-control\" id=\"password\" placeholder=\"indiana\" [(ngModel)]=\"user.password\" name=\"password\" required>\n     </div>\n\n     <button type=\"submit\" class=\"btn btn-default\">Submit</button>\n\n    </form>\n\n</div>";
...
module.exports = "<div class=\"col-md-6 col-md-offset-3\">\n\n    <form (ngSubmit)=\"calcMortgage()\" novalidate>\n\n     <div class=\"form-group\">\n       <label for=\"amount\">Amount</label>\n       <input type=\"number\" min=\"0\" class=\"form-control\" id=\"amount\" placeholder=\"enter amount\" [(ngModel)]=\"values.amount\" name=\"amount\" required>\n     </div>\n\n     <div class=\"form-group\">\n       <label for=\"month\">Months</label>\n       <input type=\"number\" min=\"1\" class=\"form-control\" id=\"month\" placeholder=\"enter months\" [(ngModel)]=\"values.month\" name=\"month\" required>\n     </div>\n\n     <div class=\"form-group\">\n       <label for=\"interest\">Interest</label>\n       <input type=\"number\" min=\"0\" max=\"100\" class=\"form-control\" id=\"interest\" placeholder=\"enter interest\" [(ngModel)]=\"values.interest\" name=\"interest\" required>\n     </div>\n\n     <button type=\"submit\" class=\"btn btn-default\">Calculate</button>\n\n    </form>\n\n    <div class=\"result-section\">\n    \t\n    \t<span >You will have to pay</span>\n    \t<span class=\"text-danger\" id=\"result-value\">{{resultValue}}</span>\n    \t<span > per month</span>\n\n    </div>\n\n</div>";
...
Object.defineProperty(exports, "__esModule", { value: true });
var login_service_1 = __webpack_require__(209);
exports.LoginService = login_service_1.LoginService;
var mortgage_service_1 = __webpack_require__(210);
exports.MortgageService = mortgage_service_1.MortgageService;
